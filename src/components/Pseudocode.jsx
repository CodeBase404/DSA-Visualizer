...
function Pseudocode({ algorithm }) {
    ...
    return (
        <div className="shadow-md shadow-green-400 p-2 w-[95%] mb-3 md:w-[90%] m-auto rounded-lg">
            ...
            <pre className="text-green-400 font-mono text-[9px] lg:text-[12px] whitespace-pre-wrap overflow-x-auto">
